                              ...
                              fluidPage(
                                  fluidRow(
                                      column(12, offset = 3, align  = "center",
                                             ...
                                             jumbotron("viz-WEPPcloud", "Sliding into DM's simplified ",
                                                     button = FALSE),
                                             
                                             tags$div(
                                                 tags$p("viz-WEPPcloud is driven by simulation outputs generated by WEPPCloud.",align = "left"), 
                                               ...
                                               post-wildfire assessments, fuel treatment planning, and prescribed fire analysis.',
                                                        .noWS = c("after-begin", "before-end"), align = "left"), 
                                                 tags$p("Third paragraph")
                                             ))),
                                            
                                  HTML("<br style = “line-height:5;”><br>"),
                                           fluidRow(
                                               column(4, align  = "center", thumbnail_label(image = 'Capture.PNG', label = 'Application 1',
                                              ...
                                              american shorthair. Norwegian forest. ',
                                                                         button_link = 'switchWatershed', button_label = 'Watershed')
                                               ),
                                               column(4, align  = "center", thumbnail_label(image = 'Rlogo.png', label = 'Application 2',
                                                                         content = 'Havana brown cornish rex bombay but bombay,
                                                    but havana brown devonshire rex and devonshire rex.
                                                    Tomcat egyptian mau. Cornish rex sphynx sphynx yet
                                                    cougar and panther. Panther siberian. Lynx munchkin
                                               ...
                                               column(4, align  = "center", thumbnail_label(image = 'Rlogo.png', label = 'Application 3',
                                                                         content = 'Havana brown cornish rex bombay but bombay,
                                                    but havana brown devonshire rex and devonshire rex.
                                                    Tomcat egyptian mau. Cornish rex sphynx sphynx yet
                                                    cougar and panther. Panther siberian. Lynx munchkin
...
server <- function(input, output, session) {
    ...
    # observeEvent(input$switchWatershed, {
    #     updateTabsetPanel(session, 1, selected = "Watershed")
    # })
