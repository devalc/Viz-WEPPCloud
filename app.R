...
ui <- navbarPage("viz-WEPPcloud",
                 ...
                 tabPanel("About", icon = icon("home"),
                          ...
                          setBackgroundImage(src = "about.JPG", shinydashboard = FALSE),
                          mainPanel(
                              fluidPage(
                                  ...
                                  fluidRow(
                                      column(12, offset = 3, align  = "center",
                                             ...
                                             HTML('<div class="jumbotron" style="background-color:#F8F8FF;">
                                                      <h1>viz-WEPPcloud</h1>
                                                      <h4>Sliding into DM simplified!</h4>
                                                      </div>')
                                  ...
                                  fluidPage(HTML("<br style = “line-height:20;”><br>"),
                                           fluidRow(
                                               ...
                                               column(4, align  = "center", 
                                                      thumbnail_label1(image = 'about.JPG', label = 'Hillslope',
                                                                         content = '... '),
                                                      actionBttn("Hbutton", "Navigate to Hillslope", icon = icon("line-chart"))),
                                               column(4, align  = "center", thumbnail_label1(image = 'about.JPG', label = 'Spatial',
                                                                         content = '... '),
                                  ...
                                  fluidRow(
                                      column(12, offset = 3, align  = "center",
                                             ...
                                             tags$div(
                                                 tags$p("viz-WEPPcloud is driven by simulation outputs generated by WEPPCloud.",align = "center"),
                                                 tags$p(a(href = 'https://wepp1.nkn.uidaho.edu/weppcloud/', 'WEPPCloud', .noWS = "outside"),
                                                        ' is a cloud based simulation tool based on the Watershed Erosion Prediction Project model. It estimates
